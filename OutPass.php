...
<div class="form_container">
    <h2>Outpass Application Form</h2>
    <form id="outpassForm" action="includes/out.pass.php" method="post" enctype="multipart/form-data">
        <!-- Leave Type -->
        ...
        <textarea id="reason" name="reason" placeholder="Provide a reason for your leave..." required></textarea>
